package com.ccr.achengdialoglibrary.dialog.widget.base;
...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog {
    ...
    protected OnButtonClickListener onBtnLeftClickL;
    /** right btn click listener(右按钮接口) */
    protected OnButtonClickListener onBtnRightClickL;
    /** middle btn click listener(右按钮接口) */
    protected OnButtonClickListener onBtnMiddleClickL;
        ...
        tv_btn_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onBtnRightClickL != null) {
                    onBtnRightClickL.onButtonClick();
                } else {
                    dismiss();
                }
            }
        ...
        tv_btn_middle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onBtnMiddleClickL != null) {
                    onBtnMiddleClickL.onButtonClick();
                } else {
                    dismiss();
                }
            }
     ...
     */
    public void setOnButtonClickListener(OnButtonClickListener... onBtnClickLs) {
