package com.ccr.achengdialoglibrary.dialog.widget.dialog;
...
import com.ccr.achengdialoglibrary.dialog.bean.DialogMenuItem;
...
public class ActionSheetDialog extends BottomBaseDialog {
    ...
    private OnOperClickListener onOperItemClickListener;
    private LayoutAnimationController lac;

    public void setOnOperItemClickListener(OnOperClickListener onOperItemClickL) {
        this.onOperItemClickListener = onOperItemClickL;
    }
    ...
    public View onCreateView() {
        ...
        /** title underline */
        v_line_title = new View(mContext);
    ...
    public void setUiBeforShow() {
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (onOperItemClickListener != null) {
                    onOperItemClickListener.onOperItemClick(parent, view, position, id);
                }
            }
        });
