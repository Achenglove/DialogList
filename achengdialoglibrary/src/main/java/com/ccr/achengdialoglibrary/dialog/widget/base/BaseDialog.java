...
import com.ccr.achengdialoglibrary.dialog.utils.StatusBarUtils;
...
public abstract class BaseDialog<T extends BaseDialog<T>> extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_top = new LinearLayout(mContext);
        ll_top.setGravity(Gravity.CENTER);

        ll_control_height = new LinearLayout(mContext);
        ...
        maxHeight = dm.heightPixels - StatusBarUtils.getHeight(mContext);
        // maxHeight = dm.heightPixels;
        setContentView(ll_top, new ViewGroup.LayoutParams(dm.widthPixels, (int) maxHeight));
        setCanceledOnTouchOutside(false);//点击dialog以外的区域关闭dialog
