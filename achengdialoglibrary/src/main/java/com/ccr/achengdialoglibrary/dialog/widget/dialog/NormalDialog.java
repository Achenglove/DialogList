...
import com.ccr.achengdialoglibrary.dialog.widget.base.BaseAlertDialog;
...
public class NormalDialog extends BaseAlertDialog<NormalDialog> {
    ...
    public View onCreateView() {
        ...
        v_line_horizontal = new View(mContext);
        ...
        v_line_vertical = new View(mContext);
        ...
        v_line_vertical2 = new View(mContext);
